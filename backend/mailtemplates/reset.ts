export default (name:string, reset:string) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">Welcome to WeChat</div>
          <div class="logo">
            <a href="https://twinkconnect.netlify.app/">
              <img src="https://i.imgur.com/KZkoFRO.png" alt="WeChat Logo" />
            </a>
          </div>
        ...
        <div class="footer">
          ...
          <p>
            ...
            <a href="mailto:${process.env.EMAIL}">twinkconnect@gmail.com</a>.
          </p>
        </div>
      </body>
    </html>
